...
class VAddNc(BaseInstruction):
    ...
    def to_fill_node(self):
        if self.suffix in ["u16", "u32"]:
            ...
            if is_reg(self.src0) and self.node.state.registers[self.src0].type == RegisterType.NUM_GROUPS_X and \
            ...
            if is_reg(self.src0) and self.node.state.registers[self.src0].type == RegisterType.NUM_GROUPS_Y and \
            ...
            if is_reg(self.src0) and self.node.state.registers[self.src0].type == RegisterType.NUM_GROUPS_Z and \
